...
<div x-cloak x-show="{{ $var }}" class="fixed top-0 left-0 right-0 z-50 w-full p-4 inset-0 max-h-full flex flex-col justify-center backdrop-blur-sm backdrop-brightness-75">
